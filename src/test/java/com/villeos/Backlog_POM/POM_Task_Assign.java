...
public class POM_Task_Assign 
{
		protected AndroidDriver driver;
		
		public  POM_Task_Assign()
		{
			
		}
		
		public  POM_Task_Assign(AndroidDriver driver1)
		{
			this.driver=driver1;
		...
		@FindBy(xpath="//android.view.ViewGroup[@text='']")
		private WebElement Notification;
		
		@FindBy(xpath="//android.widget.TextView[contains(@text,'You have been assigned')]")
		...
		public void stage_1() throws InterruptedException
		{
			...
			List<WebElement>we=driver.findElements(By.xpath("//android.widget.TextView[@index='3']"));
			
			for(WebElement w1:we)
			{
				w1.click();
				
				boolean b1=driver.findElement(By.xpath("//android.widget.CheckBox[@index='3']")).isDisplayed();
				
				if(b1)
				{
					System.out.println("Task Assign to buyer");
				}
			}
