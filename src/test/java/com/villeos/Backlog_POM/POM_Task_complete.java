...
public class POM_Task_complete 
{
	protected AndroidDriver driver;
	public  POM_Task_complete()
	{
		
	}
	
	public  POM_Task_complete(AndroidDriver driver1)
	{
		this.driver=driver1;
	...
	@FindBy(xpath="//android.widget.TextView[contains(@text,'completed the task')]")
	...
	public void stage_1() throws InterruptedException
	{
		...
		List <WebElement> we=driver.findElements(By.xpath("//android.widget.CheckBox[@text='']"));
	...
	public void stage_3() throws InterruptedException
	{
		
		Stage_3.click();
		
		driver.findElement(By.xpath("//android.widget.CheckBox[@text='']")).click();
	...
	public void notification()
	{
		...
		if(b1)
		{
			System.out.println("Task completed notification is visible at Buyer end. ");
		}
